...
% given position in the orientation defined by an se3 rotation matrix and
% plots the axis with darker colors than plotf2 does. Hence dc, darker
% colors
% Input
%   m - a 4x4 se3 matrix
...
% in cyan
plotv3(zer,zer+40*m(1:3,1),'#A2142F',2);
plotv3(zer,zer+40*m(1:3,2),'#77AC30',2);
plotv3(zer,zer+40*m(1:3,3),'#4DBEEE',2);
